...
interface Constant {
    companion object {
        ...
        val CHUNKED_TRANSFER_ENCODING_DATA_URLS = arrayOf("http://www.httpwatch.com/httpgallery/chunked/chunkedimage.aspx?0.04400023248109086")

        val LIULISHUO_APK_URL = "http://cdn.llsapp.com/android/LLS-v4.0-595-20160908-143200.apk"
        val LIULISHUO_CONTENT_DISPOSITION_FILENAME = "LLS-v4.0-595-20160908-143200.apk"

        val BIG_FILE_URLS = arrayOf(
            // 5m
