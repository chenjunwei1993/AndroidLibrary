...
public final class ServiceUtils {
    ...
    public static Set getAllRunningService() {
        ActivityManager activityManager = (ActivityManager) CoreUtils.getContext().getSystemService(Context.ACTIVITY_SERVICE);
    ...
    public static void startService(final Class<?> cls) {
        Intent intent = new Intent(CoreUtils.getContext(), cls);
        CoreUtils.getContext().startService(intent);
    }
    ...
    public static boolean stopService(final Class<?> cls) {
        Intent intent = new Intent(CoreUtils.getContext(), cls);
        return CoreUtils.getContext().stopService(intent);
    }
    ...
    public static void bindService(final Class<?> cls, final ServiceConnection conn, final int flags) {
        Intent intent = new Intent(CoreUtils.getContext(), cls);
        CoreUtils.getContext().bindService(intent, conn, flags);
    }
    ...
    public static void unbindService(final ServiceConnection conn) {
        CoreUtils.getContext().unbindService(conn);
    }
