...
public final class KeyboardUtils {
    ...
    public static boolean isSoftShowing(Activity mActivity) {
        ...
        //获取View可见区域的bottom
        int navH = BarUtils.getNavigationBarHeight(mActivity);
        Rect rect = new Rect();
    ...
    public static void showSoftInput(final View view) {
        ...
        view.requestFocus();
        InputMethodManager imm = (InputMethodManager) CoreUtils.getContext().getSystemService(Context.INPUT_METHOD_SERVICE);
        if (imm == null) {
            return;
        }
        imm.showSoftInput(view, InputMethodManager.SHOW_FORCED);
