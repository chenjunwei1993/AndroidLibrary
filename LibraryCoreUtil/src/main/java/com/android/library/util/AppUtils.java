...
import com.android.library.util.security.EncryptUtils;
...
public final class AppUtils {
    ...
    public static void installApp(final File file, final String authority) {
        ...
        CoreUtils.getContext().startActivity(getInstallAppIntent(file, authority));
    }
    ...
    public static void uninstallApp(final String packageName) {
        ...
        CoreUtils.getContext().startActivity(getUninstallAppIntent(packageName));
    }
    ...
    public static Intent getInstallAppIntent(final File file, final String authority) {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.N) {
            ...
            data = FileProvider.getUriForFile(CoreUtils.getContext(), authority, file);
        }
    ...
    public static Intent getLaunchAppIntent(final String packageName) {
        return CoreUtils.getContext().getPackageManager().getLaunchIntentForPackage(packageName);
    }
    ...
    public static void launchApp(final String packageName) {
        ...
        CoreUtils.getContext().startActivity(getLaunchAppIntent(packageName));
    }
    ...
    public static String getAppPackageName() {
        return CoreUtils.getContext().getPackageName();
    }
    ...
    public static void getAppDetailsSettings() {
        getAppDetailsSettings(CoreUtils.getContext().getPackageName());
    }
    ...
    public static void getAppDetailsSettings(final String packageName) {
        ...
        CoreUtils.getContext().startActivity(getAppDetailsSettingsIntent(packageName));
    }
    ...
    public static String getAppName() {
        return getAppName(CoreUtils.getContext().getPackageName());
    }
    ...
    public static String getAppName(final String packageName) {
        ...
        try {
            PackageManager pm = CoreUtils.getContext().getPackageManager();
    ...
    public static Drawable getAppIcon() {
        return getAppIcon(CoreUtils.getContext().getPackageName());
    }
    ...
    public static String getAppPath() {
        return getAppPath(CoreUtils.getContext().getPackageName());
    }
    ...
    public static String getAppLanguage() {
        Configuration config = CoreUtils.getContext().getResources().getConfiguration();// 获得设置对象
        Locale locale = config.locale;
        if (null != locale) {
            if (Locale.TAIWAN == locale) {
                return "TaiWan";
            }
            if (Locale.US == locale) {
                return "English";
    ...
    public static String getAppVersionName() {
        return getAppVersionName(CoreUtils.getContext().getPackageName());
    }
    ...
    public static int getAppVersionCode() {
        return getAppVersionCode(CoreUtils.getContext().getPackageName());
    }
    ...
    public static boolean isSystemApp() {
        return isSystemApp(CoreUtils.getContext().getPackageName());
    }
    ...
    public static boolean isAppDebug() {
        return isAppDebug(CoreUtils.getContext().getPackageName());
    }
    ...
    public static Signature[] getAppSignature() {
        return getAppSignature(CoreUtils.getContext().getPackageName());
    }
    ...
    public static String getAppSignatureSHA1() {
        return getAppSignatureSHA1(CoreUtils.getContext().getPackageName());
    }
    ...
    public static boolean isAppForeground() {
        ActivityManager manager = (ActivityManager) CoreUtils.getContext().getSystemService(Context.ACTIVITY_SERVICE);
        ...
        for (ActivityManager.RunningAppProcessInfo aInfo : info) {
            if (aInfo.importance == ActivityManager.RunningAppProcessInfo.IMPORTANCE_FOREGROUND) {
                return aInfo.processName.equals(CoreUtils.getContext().getPackageName());
            }
        }
        return false;
    }
    ...
    public static AppInfo getAppInfo() {
        return getAppInfo(CoreUtils.getContext().getPackageName());
    }
