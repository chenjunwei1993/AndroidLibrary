...
import com.android.library.downloader.BuildConfig;
import com.android.library.connection.FileDownloadConnection;
import com.android.library.download.CustomComponentHolder;
import com.android.library.exception.FileDownloadGiveUpRetryException;
import com.android.library.exception.FileDownloadSecurityException;
import com.android.library.model.FileDownloadModel;
import com.android.library.services.FileDownloadService;
...
import static com.android.library.model.FileDownloadModel.TOTAL_VALUE_IN_CHUNKED_RESOURCE;
...
public class FileDownloadUtils {
     ...
     * @see com.android.library.download.DownloadStatusCallback#onProgress(long)
...
//                .getExternalStorageDirectory().toString());
     ...
     * @see com.android.library.BaseDownloadTask#setPath(String, boolean)
     */
    ...
    public static String getStack(final StackTraceElement[] stackTrace, final boolean printLine) {
        ...
        for (int i = 3; i < stackTrace.length; i++) {
            if (!stackTrace[i].getClassName().contains("com.android.library")) {
                continue;
            }
            t.append("[");
            t.append(stackTrace[i].getClassName()
                    .substring("com.android.library".length()));
            t.append(":");
